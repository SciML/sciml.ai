...
world by storm as a interesting blend of traditional scientific mechanistic
...
## The Service that SciML Provides
...
It is very rare that someone things their model is perfect. Instead, a large portion
of the focus of our organization is to help scientific modelers derive equations
and fit models. This includes tools for:

- [Optimization-based and Bayesian parameter estimation](https://docs.SciML.org/dev/analysis/parameter_estimation/)
...
(for a recent demonstration, see [this fitting of a COVID-19 model](https://drive.google.com/file/d/1NxFOtpNHl7oXpdSLM06TEN_oO8QylPYx/view)).
...
Our reorganization will make it more accessible for users to find our GSA methods
to apply in non-differential equation contexts, like on neural networks.
...
We make it easy to generate models of multi-scale systems using tools like
...
that provide automatic analysis and optimization of model code.
...
Putting an arbitrary piece of code from the SciML group into ae training loop of
