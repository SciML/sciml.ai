...
keep up - problems are either too large for realistic simulation, run at greatly
varying scales, are too stiff, and often too much time is spent on things like
calculating gradients and running on GPUs and parallel computers. A combination
of science and machine learning, that combines mechanistic models with data
based reasoning, presented as a unified set of abstractions and a high
performance implementation is  the way forward. We refer to this as scientific
machine learning.
...
stiffness and interpretability and enforcing physical constraints, this blend
...
deep learning. However, new software will be required in order to accommodate
