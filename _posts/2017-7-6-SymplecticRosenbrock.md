...
[in the Refined ODE Solver docs](https://docs.juliadiffeq.org/latest/solvers/refined_ode_solve).
We have some [new physics tutorials](https://nbviewer.jupyter.org/github/JuliaDiffEq/DiffEqTutorials.jl/blob/master/PhysicalModels/ClassicalPhysics.ipynb)
...
[this page in the docs](https://docs.juliadiffeq.org/latest/features/low_dep)).
