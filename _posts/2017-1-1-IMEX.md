...
[defining a `SplitODEProblem`](http://docs.juliadiffeq.org/latest/types/split_ode_types)
is as easy as giving the two functions, and then you just choose
[one of the `KenCarp` methods](http://docs.juliadiffeq.org/latest/solvers/split_ode_solve)
