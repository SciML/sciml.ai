...
@@tight-list
- [ADVANCED LEVEL] completing / polishing tooling for chemical reaction network analysis in [CatalystNetworkAnalysis.jl](https://github.com/SciML/CatalystNetworkAnalysis.jl), and expanding the network analysis capabilities.
