...
[defining a `SplitODEProblem`](https://docs.sciml.ai/DiffEqDocs/latest/types/split_ode_types)
is as easy as giving the two functions, and then you just choose
[one of the `KenCarp` methods](https://docs.sciml.ai/DiffEqDocs/latest/solvers/split_ode_solve)
